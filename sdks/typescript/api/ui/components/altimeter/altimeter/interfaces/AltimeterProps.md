...
Defined in: [packages/ui/src/components/altimeter/altimeter.tsx:133](https://github.com/resq-software/npm/blob/a23b0e86db5c4539fd4e521f64c284c116e1324a/packages/ui/src/components/altimeter/altimeter.tsx#L133)
...
`AltimeterProps`.[`accessKey`](#accesskey)
...
Defined in: [packages/ui/src/components/altimeter/altimeter.tsx:135](https://github.com/resq-software/npm/blob/a23b0e86db5c4539fd4e521f64c284c116e1324a/packages/ui/src/components/altimeter/altimeter.tsx#L135)
...
`AltimeterProps`.[`autoCapitalize`](#autocapitalize)
...
`AltimeterProps`.[`autoCorrect`](#autocorrect)
...
`AltimeterProps`.[`autoFocus`](#autofocus)
...
`AltimeterProps`.[`autoSave`](#autosave)
...
`AltimeterProps`.[`className`](#classname)
...
`AltimeterProps`.[`content`](#content)
...
`AltimeterProps`.[`contentEditable`](#contenteditable)
...
`AltimeterProps`.[`contextMenu`](#contextmenu)
...
`AltimeterProps`.[`datatype`](#datatype)
...
`AltimeterProps`.[`defaultChecked`](#defaultchecked)
...
`AltimeterProps`.[`defaultValue`](#defaultvalue)
...
`AltimeterProps`.[`draggable`](#draggable)
...
`AltimeterProps`.[`enterKeyHint`](#enterkeyhint)
...
`AltimeterProps`.[`exportparts`](#exportparts)
...
`AltimeterProps`.[`inputMode`](#inputmode)
...
`AltimeterProps`.[`itemProp`](#itemprop)
...
`AltimeterProps`.[`itemRef`](#itemref)
...
`AltimeterProps`.[`itemScope`](#itemscope)
...
`AltimeterProps`.[`itemType`](#itemtype)
...
Defined in: [packages/ui/src/components/altimeter/altimeter.tsx:139](https://github.com/resq-software/npm/blob/a23b0e86db5c4539fd4e521f64c284c116e1324a/packages/ui/src/components/altimeter/altimeter.tsx#L139)
...
`AltimeterProps`.[`popover`](#popover)
...
`AltimeterProps`.[`popoverTarget`](#popovertarget)
...
`AltimeterProps`.[`popoverTargetAction`](#popovertargetaction)
...
`AltimeterProps`.[`property`](#property)
...
`AltimeterProps`.[`radioGroup`](#radiogroup)
...
`AltimeterProps`.[`resource`](#resource)
...
`AltimeterProps`.[`results`](#results)
...
`AltimeterProps`.[`security`](#security)
...
`AltimeterProps`.[`spellCheck`](#spellcheck)
...
`AltimeterProps`.[`suppressContentEditableWarning`](#suppresscontenteditablewarning)
...
`AltimeterProps`.[`suppressHydrationWarning`](#suppresshydrationwarning)
...
`AltimeterProps`.[`tabIndex`](#tabindex)
...
`AltimeterProps`.[`translate`](#translate)
...
Defined in: [packages/ui/src/components/altimeter/altimeter.tsx:137](https://github.com/resq-software/npm/blob/a23b0e86db5c4539fd4e521f64c284c116e1324a/packages/ui/src/components/altimeter/altimeter.tsx#L137)
...
`AltimeterProps`.[`unselectable`](#unselectable)
