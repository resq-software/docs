# Variable: MusicNotesMinusIcon

> `const` **MusicNotesMinusIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/MusicNotesMinus.d.ts:10
