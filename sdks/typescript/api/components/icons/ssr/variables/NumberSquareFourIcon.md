# Variable: NumberSquareFourIcon

> `const` **NumberSquareFourIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/NumberSquareFour.d.ts:10
