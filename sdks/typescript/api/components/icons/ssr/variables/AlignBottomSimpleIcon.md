# Variable: AlignBottomSimpleIcon

> `const` **AlignBottomSimpleIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/AlignBottomSimple.d.ts:10
