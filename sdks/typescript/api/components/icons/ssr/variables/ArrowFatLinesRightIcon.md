# Variable: ArrowFatLinesRightIcon

> `const` **ArrowFatLinesRightIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowFatLinesRight.d.ts:10
