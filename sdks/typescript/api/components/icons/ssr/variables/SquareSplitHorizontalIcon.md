# Variable: SquareSplitHorizontalIcon

> `const` **SquareSplitHorizontalIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/SquareSplitHorizontal.d.ts:10
