# Variable: AlignLeftSimpleIcon

> `const` **AlignLeftSimpleIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/AlignLeftSimple.d.ts:10
