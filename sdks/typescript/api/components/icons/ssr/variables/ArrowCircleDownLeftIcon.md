# Variable: ArrowCircleDownLeftIcon

> `const` **ArrowCircleDownLeftIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowCircleDownLeft.d.ts:10
