# Variable: ArrowBendDownRightIcon

> `const` **ArrowBendDownRightIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowBendDownRight.d.ts:10
