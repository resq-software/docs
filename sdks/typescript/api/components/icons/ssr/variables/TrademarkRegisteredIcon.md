# Variable: TrademarkRegisteredIcon

> `const` **TrademarkRegisteredIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/TrademarkRegistered.d.ts:10
