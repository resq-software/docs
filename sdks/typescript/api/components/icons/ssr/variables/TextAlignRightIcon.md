# Variable: TextAlignRightIcon

> `const` **TextAlignRightIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/TextAlignRight.d.ts:10
