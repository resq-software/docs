# Variable: ColumnsPlusRightIcon

> `const` **ColumnsPlusRightIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ColumnsPlusRight.d.ts:10
