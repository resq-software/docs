# Variable: DeviceTabletSpeakerIcon

> `const` **DeviceTabletSpeakerIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/DeviceTabletSpeaker.d.ts:10
