# Variable: ArrowSquareDownLeftIcon

> `const` **ArrowSquareDownLeftIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowSquareDownLeft.d.ts:10
