# Variable: PersonSimpleCircleIcon

> `const` **PersonSimpleCircleIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/PersonSimpleCircle.d.ts:10
