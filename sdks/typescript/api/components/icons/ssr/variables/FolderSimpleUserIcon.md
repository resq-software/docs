# Variable: FolderSimpleUserIcon

> `const` **FolderSimpleUserIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/FolderSimpleUser.d.ts:10
