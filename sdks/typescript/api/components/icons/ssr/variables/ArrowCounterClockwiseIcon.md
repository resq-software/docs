# Variable: ArrowCounterClockwiseIcon

> `const` **ArrowCounterClockwiseIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowCounterClockwise.d.ts:10
