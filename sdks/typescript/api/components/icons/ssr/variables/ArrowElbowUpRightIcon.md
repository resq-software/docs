# Variable: ArrowElbowUpRightIcon

> `const` **ArrowElbowUpRightIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowElbowUpRight.d.ts:10
