# Variable: ShieldChevronIcon

> `const` **ShieldChevronIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ShieldChevron.d.ts:10
