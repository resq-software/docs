# Variable: DotsThreeOutlineIcon

> `const` **DotsThreeOutlineIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/DotsThreeOutline.d.ts:10
