# Variable: ArrowSquareUpIcon

> `const` **ArrowSquareUpIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowSquareUp.d.ts:10
