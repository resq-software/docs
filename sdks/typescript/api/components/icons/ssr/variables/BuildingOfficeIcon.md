# Variable: BuildingOfficeIcon

> `const` **BuildingOfficeIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/BuildingOffice.d.ts:10
