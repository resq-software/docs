# Variable: SpeakerSimpleLowIcon

> `const` **SpeakerSimpleLowIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/SpeakerSimpleLow.d.ts:10
