# Variable: ArrowFatLineDownIcon

> `const` **ArrowFatLineDownIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowFatLineDown.d.ts:10
