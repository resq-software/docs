# Variable: CaretDoubleUpIcon

> `const` **CaretDoubleUpIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/CaretDoubleUp.d.ts:10
