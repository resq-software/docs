# Variable: IdentificationBadgeIcon

> `const` **IdentificationBadgeIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/IdentificationBadge.d.ts:10
