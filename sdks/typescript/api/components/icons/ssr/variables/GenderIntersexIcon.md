# Variable: GenderIntersexIcon

> `const` **GenderIntersexIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/GenderIntersex.d.ts:10
