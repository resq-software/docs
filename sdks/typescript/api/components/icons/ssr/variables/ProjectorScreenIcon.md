# Variable: ProjectorScreenIcon

> `const` **ProjectorScreenIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ProjectorScreen.d.ts:10
