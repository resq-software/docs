# Variable: ArrowElbowLeftIcon

> `const` **ArrowElbowLeftIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowElbowLeft.d.ts:10
