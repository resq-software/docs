# Variable: ArrowSquareOutIcon

> `const` **ArrowSquareOutIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowSquareOut.d.ts:10
