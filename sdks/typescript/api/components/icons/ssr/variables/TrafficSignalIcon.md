# Variable: TrafficSignalIcon

> `const` **TrafficSignalIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/TrafficSignal.d.ts:10
