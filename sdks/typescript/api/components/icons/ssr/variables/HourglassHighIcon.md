# Variable: HourglassHighIcon

> `const` **HourglassHighIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/HourglassHigh.d.ts:10
