# Variable: ArrowsLeftRightIcon

> `const` **ArrowsLeftRightIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowsLeftRight.d.ts:10
