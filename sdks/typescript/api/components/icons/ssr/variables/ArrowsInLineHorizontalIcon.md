# Variable: ArrowsInLineHorizontalIcon

> `const` **ArrowsInLineHorizontalIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowsInLineHorizontal.d.ts:10
