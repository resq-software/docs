# Variable: TerminalWindowIcon

> `const` **TerminalWindowIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/TerminalWindow.d.ts:10
