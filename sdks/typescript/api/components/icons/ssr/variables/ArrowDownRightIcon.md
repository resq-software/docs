# Variable: ArrowDownRightIcon

> `const` **ArrowDownRightIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowDownRight.d.ts:10
