# Variable: ArrowSquareRightIcon

> `const` **ArrowSquareRightIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowSquareRight.d.ts:10
