# Variable: PaperPlaneTiltIcon

> `const` **PaperPlaneTiltIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/PaperPlaneTilt.d.ts:10
