# Variable: CaretDoubleDownIcon

> `const` **CaretDoubleDownIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/CaretDoubleDown.d.ts:10
