# Variable: MusicNoteSimpleIcon

> `const` **MusicNoteSimpleIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/MusicNoteSimple.d.ts:10
