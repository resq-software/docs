# Variable: LockSimpleOpenIcon

> `const` **LockSimpleOpenIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/LockSimpleOpen.d.ts:10
