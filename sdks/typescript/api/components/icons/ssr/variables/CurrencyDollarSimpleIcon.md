# Variable: CurrencyDollarSimpleIcon

> `const` **CurrencyDollarSimpleIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/CurrencyDollarSimple.d.ts:10
