# Variable: DeviceMobileCameraIcon

> `const` **DeviceMobileCameraIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/DeviceMobileCamera.d.ts:10
