# Variable: FadersHorizontalIcon

> `const` **FadersHorizontalIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/FadersHorizontal.d.ts:10
