# Variable: ArrowBendUpLeftIcon

> `const` **ArrowBendUpLeftIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowBendUpLeft.d.ts:10
