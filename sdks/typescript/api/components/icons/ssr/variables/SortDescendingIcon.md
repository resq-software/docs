# Variable: SortDescendingIcon

> `const` **SortDescendingIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/SortDescending.d.ts:10
