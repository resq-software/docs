# Variable: CaretCircleUpDownIcon

> `const` **CaretCircleUpDownIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/CaretCircleUpDown.d.ts:10
