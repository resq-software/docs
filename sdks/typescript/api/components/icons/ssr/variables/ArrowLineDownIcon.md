# Variable: ArrowLineDownIcon

> `const` **ArrowLineDownIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/ArrowLineDown.d.ts:10
