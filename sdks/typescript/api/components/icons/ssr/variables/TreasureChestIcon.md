# Variable: TreasureChestIcon

> `const` **TreasureChestIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/TreasureChest.d.ts:10
