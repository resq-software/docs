# Variable: AlignTopSimpleIcon

> `const` **AlignTopSimpleIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/AlignTopSimple.d.ts:10
