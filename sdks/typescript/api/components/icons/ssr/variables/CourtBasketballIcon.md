# Variable: CourtBasketballIcon

> `const` **CourtBasketballIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/CourtBasketball.d.ts:10
