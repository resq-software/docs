# Variable: CaretLineDownIcon

> `const` **CaretLineDownIcon**: [`Icon`](../../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/ssr/CaretLineDown.d.ts:10
