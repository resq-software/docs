# Variable: TelevisionSimpleIcon

> `const` **TelevisionSimpleIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/TelevisionSimple.d.ts:10
