# Variable: CaretDoubleRightIcon

> `const` **CaretDoubleRightIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/CaretDoubleRight.d.ts:10
