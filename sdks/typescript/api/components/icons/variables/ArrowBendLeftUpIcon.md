# Variable: ArrowBendLeftUpIcon

> `const` **ArrowBendLeftUpIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowBendLeftUp.d.ts:10
