# Variable: SubsetProperOfIcon

> `const` **SubsetProperOfIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/SubsetProperOf.d.ts:10
