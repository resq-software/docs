# Variable: PresentationChartIcon

> `const` **PresentationChartIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/PresentationChart.d.ts:10
