# Variable: ArrowSquareUpLeftIcon

> `const` **ArrowSquareUpLeftIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowSquareUpLeft.d.ts:10
