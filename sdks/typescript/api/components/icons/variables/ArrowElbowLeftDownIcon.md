# Variable: ArrowElbowLeftDownIcon

> `const` **ArrowElbowLeftDownIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowElbowLeftDown.d.ts:10
