# Variable: AlignRightSimpleIcon

> `const` **AlignRightSimpleIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/AlignRightSimple.d.ts:10
