# Variable: NumberCircleSevenIcon

> `const` **NumberCircleSevenIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/NumberCircleSeven.d.ts:10
