# Variable: SpeakerSimpleXIcon

> `const` **SpeakerSimpleXIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/SpeakerSimpleX.d.ts:10
