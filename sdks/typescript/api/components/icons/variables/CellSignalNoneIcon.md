# Variable: CellSignalNoneIcon

> `const` **CellSignalNoneIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/CellSignalNone.d.ts:10
