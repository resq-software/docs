# Variable: ShoppingCartSimpleIcon

> `const` **ShoppingCartSimpleIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ShoppingCartSimple.d.ts:10
