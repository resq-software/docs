# Variable: WashingMachineIcon

> `const` **WashingMachineIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/WashingMachine.d.ts:10
