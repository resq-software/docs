# Variable: GoogleCardboardLogoIcon

> `const` **GoogleCardboardLogoIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/GoogleCardboardLogo.d.ts:10
