# Variable: ChatTeardropTextIcon

> `const` **ChatTeardropTextIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ChatTeardropText.d.ts:10
