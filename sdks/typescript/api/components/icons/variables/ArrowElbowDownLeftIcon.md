# Variable: ArrowElbowDownLeftIcon

> `const` **ArrowElbowDownLeftIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowElbowDownLeft.d.ts:10
