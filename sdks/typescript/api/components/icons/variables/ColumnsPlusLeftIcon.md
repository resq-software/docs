# Variable: ColumnsPlusLeftIcon

> `const` **ColumnsPlusLeftIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ColumnsPlusLeft.d.ts:10
