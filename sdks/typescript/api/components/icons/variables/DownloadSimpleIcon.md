# Variable: DownloadSimpleIcon

> `const` **DownloadSimpleIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/DownloadSimple.d.ts:10
