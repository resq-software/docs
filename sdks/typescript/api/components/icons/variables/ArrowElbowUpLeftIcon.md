# Variable: ArrowElbowUpLeftIcon

> `const` **ArrowElbowUpLeftIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowElbowUpLeft.d.ts:10
