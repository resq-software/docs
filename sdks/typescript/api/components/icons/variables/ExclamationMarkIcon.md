# Variable: ExclamationMarkIcon

> `const` **ExclamationMarkIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ExclamationMark.d.ts:10
