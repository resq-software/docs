# Variable: LockLaminatedIcon

> `const` **LockLaminatedIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/LockLaminated.d.ts:10
