# Variable: MagnifyingGlassPlusIcon

> `const` **MagnifyingGlassPlusIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/MagnifyingGlassPlus.d.ts:10
