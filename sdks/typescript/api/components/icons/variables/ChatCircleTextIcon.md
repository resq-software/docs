# Variable: ChatCircleTextIcon

> `const` **ChatCircleTextIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ChatCircleText.d.ts:10
