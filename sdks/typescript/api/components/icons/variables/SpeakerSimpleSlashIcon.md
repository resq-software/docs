# Variable: SpeakerSimpleSlashIcon

> `const` **SpeakerSimpleSlashIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/SpeakerSimpleSlash.d.ts:10
