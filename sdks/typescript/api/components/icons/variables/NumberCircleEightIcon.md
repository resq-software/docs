# Variable: NumberCircleEightIcon

> `const` **NumberCircleEightIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/NumberCircleEight.d.ts:10
