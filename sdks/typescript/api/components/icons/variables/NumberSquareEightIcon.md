# Variable: NumberSquareEightIcon

> `const` **NumberSquareEightIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/NumberSquareEight.d.ts:10
