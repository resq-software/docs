# Variable: SelectionSlashIcon

> `const` **SelectionSlashIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/SelectionSlash.d.ts:10
