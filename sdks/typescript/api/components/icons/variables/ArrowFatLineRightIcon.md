# Variable: ArrowFatLineRightIcon

> `const` **ArrowFatLineRightIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowFatLineRight.d.ts:10
