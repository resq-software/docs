# Variable: ArrowURightUpIcon

> `const` **ArrowURightUpIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowURightUp.d.ts:10
