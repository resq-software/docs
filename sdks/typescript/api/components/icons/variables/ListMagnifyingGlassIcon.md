# Variable: ListMagnifyingGlassIcon

> `const` **ListMagnifyingGlassIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ListMagnifyingGlass.d.ts:10
