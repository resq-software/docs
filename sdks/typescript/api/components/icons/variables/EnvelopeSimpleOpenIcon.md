# Variable: EnvelopeSimpleOpenIcon

> `const` **EnvelopeSimpleOpenIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/EnvelopeSimpleOpen.d.ts:10
