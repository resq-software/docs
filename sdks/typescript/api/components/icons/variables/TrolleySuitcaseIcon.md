# Variable: TrolleySuitcaseIcon

> `const` **TrolleySuitcaseIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/TrolleySuitcase.d.ts:10
