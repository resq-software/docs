# Variable: ChalkboardSimpleIcon

> `const` **ChalkboardSimpleIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ChalkboardSimple.d.ts:10
