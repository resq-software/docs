# Variable: CalendarMinusIcon

> `const` **CalendarMinusIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/CalendarMinus.d.ts:10
