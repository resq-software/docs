# Variable: BatteryChargingIcon

> `const` **BatteryChargingIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/BatteryCharging.d.ts:10
