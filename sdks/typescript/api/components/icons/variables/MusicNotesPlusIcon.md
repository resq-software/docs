# Variable: MusicNotesPlusIcon

> `const` **MusicNotesPlusIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/MusicNotesPlus.d.ts:10
