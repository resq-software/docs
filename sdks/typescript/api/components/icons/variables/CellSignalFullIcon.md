# Variable: CellSignalFullIcon

> `const` **CellSignalFullIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/CellSignalFull.d.ts:10
