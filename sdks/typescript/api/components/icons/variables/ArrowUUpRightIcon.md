# Variable: ArrowUUpRightIcon

> `const` **ArrowUUpRightIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowUUpRight.d.ts:10
