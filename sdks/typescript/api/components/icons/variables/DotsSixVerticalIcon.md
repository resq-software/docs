# Variable: DotsSixVerticalIcon

> `const` **DotsSixVerticalIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/DotsSixVertical.d.ts:10
