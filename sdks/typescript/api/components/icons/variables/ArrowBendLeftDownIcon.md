# Variable: ArrowBendLeftDownIcon

> `const` **ArrowBendLeftDownIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowBendLeftDown.d.ts:10
