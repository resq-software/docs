# Variable: CaretLineLeftIcon

> `const` **CaretLineLeftIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/CaretLineLeft.d.ts:10
