# Variable: CellSignalHighIcon

> `const` **CellSignalHighIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/CellSignalHigh.d.ts:10
