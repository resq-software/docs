# Variable: SortAscendingIcon

> `const` **SortAscendingIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/SortAscending.d.ts:10
