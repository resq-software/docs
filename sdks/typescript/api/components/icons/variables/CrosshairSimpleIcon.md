# Variable: CrosshairSimpleIcon

> `const` **CrosshairSimpleIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/CrosshairSimple.d.ts:10
