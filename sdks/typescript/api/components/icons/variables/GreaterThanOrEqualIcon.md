# Variable: GreaterThanOrEqualIcon

> `const` **GreaterThanOrEqualIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/GreaterThanOrEqual.d.ts:10
