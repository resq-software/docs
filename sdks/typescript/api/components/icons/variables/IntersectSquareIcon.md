# Variable: IntersectSquareIcon

> `const` **IntersectSquareIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/IntersectSquare.d.ts:10
