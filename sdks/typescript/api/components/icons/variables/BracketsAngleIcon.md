# Variable: BracketsAngleIcon

> `const` **BracketsAngleIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/BracketsAngle.d.ts:10
