# Variable: ArrowElbowLeftUpIcon

> `const` **ArrowElbowLeftUpIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ArrowElbowLeftUp.d.ts:10
