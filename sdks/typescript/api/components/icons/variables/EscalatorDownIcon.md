# Variable: EscalatorDownIcon

> `const` **EscalatorDownIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/EscalatorDown.d.ts:10
