# Variable: SpeakerSimpleNoneIcon

> `const` **SpeakerSimpleNoneIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/SpeakerSimpleNone.d.ts:10
