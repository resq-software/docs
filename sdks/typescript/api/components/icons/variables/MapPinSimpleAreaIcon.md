# Variable: MapPinSimpleAreaIcon

> `const` **MapPinSimpleAreaIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/MapPinSimpleArea.d.ts:10
