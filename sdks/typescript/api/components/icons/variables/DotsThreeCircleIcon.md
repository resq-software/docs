# Variable: DotsThreeCircleIcon

> `const` **DotsThreeCircleIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/DotsThreeCircle.d.ts:10
