# Variable: SuitcaseSimpleIcon

> `const` **SuitcaseSimpleIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/SuitcaseSimple.d.ts:10
