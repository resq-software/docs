# Variable: NumberSquareFiveIcon

> `const` **NumberSquareFiveIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/NumberSquareFive.d.ts:10
