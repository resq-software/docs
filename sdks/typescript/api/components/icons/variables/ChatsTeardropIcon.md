# Variable: ChatsTeardropIcon

> `const` **ChatsTeardropIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ChatsTeardrop.d.ts:10
