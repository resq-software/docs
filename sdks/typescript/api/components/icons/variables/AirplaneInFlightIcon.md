# Variable: AirplaneInFlightIcon

> `const` **AirplaneInFlightIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/AirplaneInFlight.d.ts:10
