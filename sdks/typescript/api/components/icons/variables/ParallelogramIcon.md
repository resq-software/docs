# Variable: ParallelogramIcon

> `const` **ParallelogramIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/Parallelogram.d.ts:10
