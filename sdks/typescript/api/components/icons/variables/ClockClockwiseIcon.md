# Variable: ClockClockwiseIcon

> `const` **ClockClockwiseIcon**: [`Icon`](../type-aliases/Icon.md)

Defined in: node\_modules/@phosphor-icons/react/dist/csr/ClockClockwise.d.ts:10
