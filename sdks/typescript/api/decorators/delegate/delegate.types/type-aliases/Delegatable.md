...
> **Delegatable**\<`T`, `D`\> = (`target`, `propertyName`, `descriptor`) => `TypedPropertyDescriptor`\<[`AsyncMethod`](../../../types/type-aliases/AsyncMethod.md)\<`D`\>\>
...
`TypedPropertyDescriptor`\<[`AsyncMethod`](../../../types/type-aliases/AsyncMethod.md)\<`D`\>\>
