---
sidebarTitle: 'HealthResponse(string, bool, bool, bool)'
---
...
<a name='ResQ.Clients.HealthResponse.HealthResponse(string,bool,bool,bool).Status'></a>

`Status` [System\.String](https://learn.microsoft.com/en-us/dotnet/api/system.string 'System\.String')

<a name='ResQ.Clients.HealthResponse.HealthResponse(string,bool,bool,bool).Pinata'></a>

`Pinata` [System\.Boolean](https://learn.microsoft.com/en-us/dotnet/api/system.boolean 'System\.Boolean')

<a name='ResQ.Clients.HealthResponse.HealthResponse(string,bool,bool,bool).Gemini'></a>

`Gemini` [System\.Boolean](https://learn.microsoft.com/en-us/dotnet/api/system.boolean 'System\.Boolean')

<a name='ResQ.Clients.HealthResponse.HealthResponse(string,bool,bool,bool).Blockchain'></a>
