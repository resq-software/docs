...
<a name='ResQ.Clients.LocationDto.LocationDto(double,double,double).Latitude'></a>

`Latitude` [System\.Double](https://learn.microsoft.com/en-us/dotnet/api/system.double 'System\.Double')

<a name='ResQ.Clients.LocationDto.LocationDto(double,double,double).Longitude'></a>

`Longitude` [System\.Double](https://learn.microsoft.com/en-us/dotnet/api/system.double 'System\.Double')

<a name='ResQ.Clients.LocationDto.LocationDto(double,double,double).Altitude'></a>
