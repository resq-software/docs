...
| Constructors | |
| :--- | :--- |
| [UploadResponse\(string, long, string\)](./ResQ.Clients.UploadResponse.UploadResponse(string,long,string).md 'ResQ\.Clients\.UploadResponse\.UploadResponse\(string, long, string\)') | Response from an IPFS upload operation\. |
