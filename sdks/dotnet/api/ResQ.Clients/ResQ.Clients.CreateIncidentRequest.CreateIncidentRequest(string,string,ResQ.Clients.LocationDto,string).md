...
<a name='ResQ.Clients.CreateIncidentRequest.CreateIncidentRequest(string,string,ResQ.Clients.LocationDto,string).IncidentType'></a>

`IncidentType` [System\.String](https://learn.microsoft.com/en-us/dotnet/api/system.string 'System\.String')

<a name='ResQ.Clients.CreateIncidentRequest.CreateIncidentRequest(string,string,ResQ.Clients.LocationDto,string).Severity'></a>
