...
```csharp
System.Threading.Tasks.Task<bool> UnpinAsync(string cid, System.Threading.CancellationToken cancellationToken=default(System.Threading.CancellationToken));
```
#### Parameters

<a name='ResQ.Storage.IStorageClient.UnpinAsync(string,System.Threading.CancellationToken).cid'></a>
...
<a name='ResQ.Storage.IStorageClient.UnpinAsync(string,System.Threading.CancellationToken).cancellationToken'></a>
