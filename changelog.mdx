...
<Update label="September 2026" tags={["TypeScript", "Rust"]}>
  ## TypeScript

  | Package | Version |
  |---------|---------|
  | `@resq-systems/map` | 4.0.0 |
  | `@resq-systems/email-templates` | 1.2.0 |
  | `@resq-systems/ui` | 0.42.0 |
  ...
  |---------|---------|
  | `resq-cli` | 0.4.7 |
  | `resq-bin`, `resq-clean`, `resq-flame` | 0.1.26 |
  | `resq-perf` | 0.1.22 |
  | `resq-tui` | 0.1.18 |
  | `resq-dsa` | 0.1.4 |
  | `resq-ai` | 0.1.3 |
...
<Update label="July 2026" tags={["TypeScript", "Rust"]}>
  ...
  **`@resq-sw` is not deprecated on npm, so installs still resolve — silently, to
  ...
  | Package | Version |
  |---------|---------|
  | `resq-bin`, `resq-clean`, `resq-flame`, `resq-perf` | 0.1.18 |
  | `resq-tui` | 0.1.10 |
</Update>
...
<Update label="June 2026" tags={["Rust"]}>
  ...
  | Package | Version |
  |---------|---------|
  | `resq-bin`, `resq-clean`, `resq-flame`, `resq-perf` | 0.1.17 |
  | `resq-tui` | 0.1.9 |
</Update>
...
<Update label="May 2026" tags={["TypeScript", "Rust"]}>
  ...
  | Package | Version |
  |---------|---------|
  | `resq-bin`, `resq-clean`, `resq-flame`, `resq-perf` | 0.1.16 |
  | `resq-tui` | 0.1.8 |
  | `resq-dsa` | 0.1.3 |
</Update>

<Update label="April 2026" tags={["TypeScript", "Rust", ".NET"]}>
  **Rust CLI tools renamed.** The seven CLI tools were renamed on 3 April 2026.
  ...
  |---------|---------|
  | `resq-cli` | 0.2.6 |
  | `resq-bin`, `resq-clean`, `resq-flame`, `resq-perf` | 0.1.15 |
  | `resq-tui` | 0.1.7 |
  | `resq-dsa` | 0.1.2 |
  | `resq-ai` | 0.1.0 |
